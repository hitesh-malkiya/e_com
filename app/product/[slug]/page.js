        ...
        return (
          ...
          >
              ...
              <Link href={`/product/${product._id}`} className="">
                {product.image ? (
                  <Image
                    ...
                    width={500}
                    height={500}
                    className=" w-full object-contain rounded-md bg-[var(--sec-bg-color)] hover:scale-[1.03] overflow-hidden transition duration-300"
                  />
                ) : 'No Image'}
              </Link>
            ...
            <div className=' flex flex-col gap-3   items-start'>
              {/* categery and admin */}
              <div className="flex items-center gap-2 text-xl text-[var(--text-color)]">
              ...
              <div >
                <span className='text-xl text-[var(--sec-accent-color)] pt-20  bb-4'>more detalse</span>
